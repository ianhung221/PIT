...
### 目前修改順序與進度（更新於 2026-09-13）

目前進行：**Batch 2 — 已完成實作與自動驗證，等待玩家正式網站複驗**

下一批：**Batch 3 — 道路完整性、多車道路載入及天候**

| 批次 | 狀態 | 目前範圍與問題歸屬 |
| --- | --- | --- |
| Batch 1 — 車模與座標基準 | ⚠️ 主要完成 | 車頭方向與官方材質已修正；跑車、SUV 的完整警用塗裝延至 V3。U-007 的精細碰撞邊界歸入 Batch 5，因為必須與 PIT 接觸區域一起校正。 |
| Batch 2 — 駕駛視角、後看、後視鏡與直升機 | 🧪 等待玩家複驗 | 駕駛艙與鏡面已固定至相機姿態；90 公尺取景改為連續權重；直升機改為受限轉向的斜向構圖；U-008 已加入遠距方向箭頭。完整迷你地圖延至 V3。 |
| Batch 3 — 道路完整性與天候 | ⬜ 未開始 | 道路交界缺口、多車道路載入、U-006 雪花同步成平面、U-009 雨雪相對車速移動及 U-011 道路虛線／速度感提示。 |
...
Batch 2 必須先完成並通過玩家複驗，才提出 Batch 3 的執行計畫與核准；本次文件更新不構成任何程式修改授權。
